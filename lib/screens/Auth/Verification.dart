...
import 'package:project_user/controllers/Auth/Verification_controler.dart';
...
import 'package:project_user/widgets/Verification/bottion.dart';
...
class Verification extends StatelessWidget {
  ...
  VerificationControler controller = Get.put(VerificationControler());
  @override
  Widget build(BuildContext context) {
    return GetBuilder<VerificationControler>(
  ...
  title: IconButton(
    ...
    onPressed: controller.goToBack,
     ...
     Image.asset(ImageAssets.photoVerification,height: 214,width: 242,),

              SizedBox(height: 10),
              tTitle(text: "Verification Code"),
              SizedBox(height: 10),
...
GetBuilder<VerificationControler>(
