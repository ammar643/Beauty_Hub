...
class AcceptedReservationsScreen extends StatelessWidget {
   AcceptedReservationsScreen({super.key});
 ...
 final HomeController controller = Get.find();
  ...
  children: [
    ...
    _statusButton("accept", true),

    const SizedBox(width: 10),

   GestureDetector(
  onTap: () {
    Get.to(() => CanceledReservationsScreen());
  },
  ...
  static Widget _reservationCard() {
    return Container(
      ...
      child: Row(
        children: [
           CircleAvatar(
            radius: 25,
            backgroundImage:
                AssetImage(ImageAssets.photoreservations),
          ),
